	...
	public function widget($args, $instance) {
		...
		<?php echo $before_widget; ?>
			<div class="sci-contact">
				...
				<?php if (!empty($phone) && ((isset($show_phone)) && ($show_phone == 'on'))) : ?><p class="sci-address-phone"><?php if (isset($show_phone_label) && $show_phone_label == 'on') : ?><span><?php _e("Phone:", "simple-contact-info"); ?> </span><?php endif; ?><?php echo $phone; ?></p><?php endif; ?>
				<?php if (!empty($mob_phone) && ((isset($show_mob_phone)) && ($show_mob_phone == 'on'))) : ?><p class="sci-address-mob-phone"><?php if (isset($show_mob_phone_label) && $show_mob_phone_label == 'on') : ?><span><?php _e("Mobile Phone:", "simple-contact-info"); ?> </span><?php endif; ?><?php echo $mob_phone; ?></p><?php endif; ?>
				<?php if (!empty($fax) && ((isset($show_fax)) && ($show_fax == 'on'))) : ?><p class="sci-address-fax"><?php if (isset($show_fax_label) && $show_fax_label == 'on') : ?><span><?php _e("Fax:", "simple-contact-info"); ?> </span><?php endif; ?><?php echo $fax; ?></p><?php endif; ?>
				<?php if (!empty($email) && ((isset($show_email)) && ($show_email == 'on'))) : ?><p class="sci-address-email"><?php if (isset($show_email_label) && $show_email_label == 'on') : ?><span><?php _e("Email:", "simple-contact-info"); ?> </span><?php endif; ?><a href="mailto:<?php echo $email; ?>" rel="nofollow"><?php echo $email; ?></a></p><?php endif; ?>
			</div>
